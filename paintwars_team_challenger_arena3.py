...
def step(robotId, sensors): 
    ...
    #comportement du robot 3 seulement, lorsqu il rencontre un robot adverse il le suit
    if(robotId == 3):
    ...
    #comportement pour le robot 0 et 7 ils evitent les murs et les autres robots differement des autres, voir leur rotation     
...
#Fonctionne tres bien pour l arena 3 des deux cotes       
